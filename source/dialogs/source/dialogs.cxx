...
const std::string dl_s_cli_label  = "dl_s_cli";
const std::string workInProg    = "Work in progress";

const std::string dl_s_cliWelcome = " dl_s_cli - A command line interface for Synology Download Station";
const std::string dl_s_cliVer     = " version 0.0 ";
...
const std::string msgNewUserOk  = "Thank you for using dl_s_cli. Configuration files have been written\
                                   to ~/.dl_s_cli/. You can change the settings by pressing 's'. Enjoy!";

const std::string msgNewUserErr = "There was an error when initializing dl_s_cli configuration files.\
                                   Check syslog using the following command for more informations:\
                                   \nlog show --predicate \"process == 'dl_s_cli'\"";
...
const std::string msgHelpExit           = " F1          :Exit dl_s_cli ";
